...
def _activity_rows() -> pd.DataFrame:
    return pd.DataFrame(
        [
            {"period": "2025-03", "Currency": "USD", "debtor": "PM", "creditor": "MI", "pair": "PM → MI", "activity_type": "opening_balance", "new_principal": 0.0, "interest_accrued": 0.0, "repayments": 0.0, "adjustments": 0.0, "net_change": 0.0},
            {"period": "2025-03", "Currency": "USD", "debtor": "PM", "creditor": "MI", "pair": "PM → MI", "activity_type": "repayment", "new_principal": 0.0, "interest_accrued": 0.0, "repayments": 100.0, "adjustments": 0.0, "net_change": 0.0},
            {"period": "2025-03", "Currency": "USD", "debtor": "PM", "creditor": "MI", "pair": "PM → MI", "activity_type": "repayment", "new_principal": 0.0, "interest_accrued": 0.0, "repayments": 80.0, "adjustments": 0.0, "net_change": 0.0},
            {"period": "2025-03", "Currency": "USD", "debtor": "PM", "creditor": "MI", "pair": "PM → MI", "activity_type": "adjustment", "new_principal": 0.0, "interest_accrued": 0.0, "repayments": 0.0, "adjustments": 5.0, "net_change": 0.0},
            {"period": "2025-04", "Currency": "USD", "debtor": "PM", "creditor": "MI", "pair": "PM → MI", "activity_type": "repayment", "new_principal": 0.0, "interest_accrued": 0.0, "repayments": 170.0, "adjustments": 0.0, "net_change": 0.0},
        ]
    )
...
def test_annual_governed_activity_exposes_mart_semantic_leakage_as_residual() -> None:
    source = pd.DataFrame(
        [
            {"period": "2025-03", "Currency": "USD", "debtor": "PM", "creditor": "MI", "pair": "PM → MI", "activity_type": "repayment", "repayments": 10.0},
            {"period": "2025-03", "Currency": "USD", "debtor": "PM", "creditor": "MI", "pair": "PM → MI", "activity_type": "adjustment", "repayments": 5.0},
        ]
    )
    row = pd.Series({"Currency": "USD", "debtor": "PM", "creditor": "MI", "pair": "PM → MI", "activity_type": "repayments"})
...
def test_unregistered_settlements_fail_closed_without_legacy_sum() -> None:
    row = pd.Series({"Currency": "USD", "debtor": "PM", "creditor": "MI", "pair": "PM → MI", "activity_type": "settlements"})
    result = professional._build_annual_debt_activity_companion_cell(
        row=row,
        period="2025",
        display_value=350.0,
...
def test_activity_source_without_activity_type_is_not_silently_upgraded() -> None:
    source = pd.DataFrame([{"period": "2025-03", "Currency": "USD", "debtor": "PM", "creditor": "MI", "repayments": 180.0}])
    row = pd.Series({"measure": "repayments", "Currency": "USD", "pair": "PM → MI"})
    result = professional._build_debt_activity_cell(
        row=row,
        period="2025-03",
...
def test_position_and_activity_executors_are_structurally_non_interchangeable() -> None:
    activity_executor = Path("accounting/professional/debt_activity_executor.py").read_text(encoding="utf-8")
    position_executor = Path("accounting/professional/debt_position_executor.py").read_text(encoding="utf-8")
